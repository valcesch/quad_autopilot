...
#define configTICK_RATE_HZ                        ((TickType_t)500) /* frequency of tick interrupt */
...
#define configTOTAL_HEAP_SIZE                     ((size_t)(7000)) /* size of heap in bytes */
...
#define configUSE_16_BIT_TICKS                    1 /* 1: use 16bit tick counter type, 0: use 32bit tick counter type */
